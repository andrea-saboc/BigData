...
if __name__ == '__main__':
    ...
    number_per_level=df \
        ...
        .count()
    #number_per_level=df.withWatermark("timestamp", "15 seconds")

    print("Console outut:")
    console_output = number_per_level.writeStream \
    .outputMode("complete") \
    .format("console") \
    ...
    number_per_level\
       .writeStream\
          .outputMode("complete")\
         .foreachBatch(lambda df, epoch_id: write_df(df, epoch_id, "Number_segments_of_congestion_level")) \
        .start()
    number_per_level.awaitTermination()
